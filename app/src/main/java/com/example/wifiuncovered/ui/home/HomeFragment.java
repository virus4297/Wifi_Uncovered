...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        RecyclerView recyclerView = root.findViewById(R.id.ip_RecyclerView);
        //initRecyclerView
        recyclerView.setHasFixedSize(true);
        //get adapter data from HomeViewModel
        MyAdapter adapter=homeViewModel.getAdapter(getContext());
